...
---@param [emitter_state_function] function(self, id, emitter, state)|object|hash|hash|constant optional callback function that will be called when an emitter attached to this particlefx changes state. <dl> <dt>self</dt> <dd> The current object</dd> <dt>id</dt> <dd> The id of the particle fx component</dd> <dt>emitter</dt> <dd> The id of the emitter</dd> <dt>state</dt> <dd> the new state of the emitter:</dd> </dl> <ul> particlefx.EMITTER_STATE_SLEEPING particlefx.EMITTER_STATE_PRESPAWN particlefx.EMITTER_STATE_SPAWNING particlefx.EMITTER_STATE_POSTSPAWN </ul>
