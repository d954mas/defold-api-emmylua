...
--- Calling <a href="/ref/factory#factory.create">factory.create</a> create on a factory that is marked as dynamic without having loaded resources
...
---@return constant status of the factory component <ul> factory.STATUS_UNLOADED factory.STATUS_LOADING factory.STATUS_LOADED </ul>
...
---@param [complete_function] function(self, url, result))|object|url|boolean function to call when resources are loaded. <dl> <dt>self</dt> <dd> The current object.</dd> <dt>url</dt> <dd> url of the factory component</dd> <dt>result</dt> <dd> True if resources were loaded successfully</dd> </dl>
