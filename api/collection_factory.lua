...
--- Calling <a href="/ref/collectionfactory#collectionfactory.create">collectionfactory.create</a> create on a collection factory that is marked as dynamic without having loaded resources
...
---@return constant status of the collection factory component <ul> collectionfactory.STATUS_UNLOADED collectionfactory.STATUS_LOADING collectionfactory.STATUS_LOADED </ul>
...
---@param [complete_function] function(self, url, result))|object|url|boolean function to call when resources are loaded. <dl> <dt>self</dt> <dd> The current object.</dd> <dt>url</dt> <dd> url of the collection factory component</dd> <dt>result</dt> <dd> True if resource were loaded successfully</dd> </dl>
