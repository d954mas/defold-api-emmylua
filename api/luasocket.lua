...
---
--- This is an internal method, any use is unlikely to be portable.
---@return handle number the descriptor or handle. In case the object has been closed, the return will be -1.
...
---@return value any the option value, or 
---@return error string the error message, or 
function client:getoption(option) end
---Returns information about the remote side of a connected client object.
---
--- It makes no sense to call this method on server objects.
---@return info string a string with the IP address of the peer, the port number that peer is using for the connection, and the family ("inet" or "inet6"). In case of error, the method returns 
function client:getpeername() end
---Returns the local address information associated to the object.
---@return info string a string with local IP address, the local port number, and the family ("inet" or "inet6"). In case of error, the method returns 
function client:getsockname() end
---Returns accounting information on the socket, useful for throttling of bandwidth.
---@return stats string a string with the number of bytes received, the number of bytes sent, and the age of the socket object in seconds.
...
---@return data string the received pattern, or 
---@return error string the error message, or 
---@return partial string a (possibly empty) string containing the partial that was received, or 
...
---@return index number the index of the last byte within [i, j] that has been sent, or 
---@return error string the error message, or 
---@return lastindex number in case of error, the index of the last byte within [i, j] that has been sent. You might want to try again from the byte following that. 
...
---@param option string the name of the option to set. The value is provided in the 
---@param value any the value to set for the specified option.
---@return status number the value 
---@return error string the error message, or 
...
---@return success number the value 
...
---@param value number the amount of time to wait, in seconds. The 
...
---@return info string a string with local IP address, a number with the local port, and the family ("inet" or "inet6"). In case of error, the method returns 
...
---@return datagram string the received datagram, or 
---@return error string the error message, or 
...
---@param address string an IP address or a host name. If address is 
...
---@return tcp_client client if a connection is successfully initiated, a client object is returned, or 
---@return error string the error message, or 
...
---@param family string optional socket family to use, 
---@return tcp_client client a new IPv6 TCP client object, or 
---@return error string the error message, or 
...
---@return resolved table a table with all information returned by the resolver, or if an error occurs, 
---@return error string the error message, or 
function socket.dns.getaddrinfo(address) end
---Returns the standard host name for the machine as a string.
---@return hostname string the host name for the machine.
...
---@return hostname string the canonic host name of the given address, or 
---@return resolved table | string a table with all information returned by the resolver, or if an error occurs, the error message string.
...
---@return ip_address string the first IP address found for the hostname, or 
---@return resolved table | string a table with all information returned by the resolver, or if an error occurs, the error message string.
...
---@return seconds number the number of seconds elapsed.
...
---@return try function the customized try function.
...
---@return safe_func function(function()) an equivalent function that instead of throwing exceptions, returns 
...
---@return sockets_r table a list with the sockets ready for reading.
---@return sockets_w table a list with the sockets ready for writing.
---@return error string an error message. "timeout" if a timeout condition was met, otherwise 
...
---@return [retD+1] any argument D+1.
---@return [retD+2] any argument D+2.
---@return [retN] any argument N.
...
---@return tcp_master master a new IPv4 TCP master object, or 
---@return error string the error message, or 
function socket.tcp() end
---Creates and returns an IPv6 TCP master object. A master object can be transformed into a server object with the method listen (after a call to bind) or into a client object with the method connect. The only other method supported by a master object is the close method.
---
---Note: The TCP object returned will have the option "ipv6-v6only" set to true.
---@return tcp_master master a new IPv6 TCP master object, or 
---@return error string the error message, or 
...
---@return upd_unconnected unconnected a new unconnected IPv4 UDP object, or 
---@return error string the error message, or 
...
---@return udp_unconnected unconnected a new unconnected IPv6 UDP object, or 
---@return error string the error message, or 
...
---@return datagram string the received datagram, or 
---@return ip_or_error string the IP address, or the error message in case of error.
---@return port number the port number, or 
...
---@param address string an IP address or a host name. If address is "*" the system binds to all local interfaces using the constant 
