...
--<dl>
--<dt>vector3</dt>
--<dd>x, y and z. Example: v.y</dd>
--<dt>vector4</dt>
--<dd>x, y, z, and w. Example: v.w</dd>
--<dt>quaternion</dt>
--<dd>x, y, z, and w. Example: q.w</dd>
--<dt>matrix4</dt>
--<dd>m00 to m33 where the first number is the row (starting from 0) and the second
--number is the column. Columns can be accessed with c0 to c3, returning a vector4.
--Example: m.m21 which is equal to m.c1.z</dd>
--<dt>vector</dt>
--<dd>indexed by number 1 to the vector length. Example: v[3]</dd>
--</dl>
---@class vmath
local vmath = {}
