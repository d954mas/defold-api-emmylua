...
---@return y number bitwise arithmetic right-shifted number
function bit.arshift(x, n) end
---Returns the bitwise and of all of its arguments. Note that more than two arguments are allowed.
---@param x1 number number
---@param ... number number(s)
---@return y number bitwise and of the provided arguments
function bit.band(x1, ...) end
---Returns the bitwise not of its argument.
---@param x number number
---@return y number bitwise not of number x
function bit.bnot(x) end
---Returns the bitwise or of all of its arguments. Note that more than two arguments are allowed.
---@param x1 number number
---@param ... number number(s)
---@return y number bitwise or of the provided arguments
function bit.bor(x1, ...) end
---Swaps the bytes of its argument and returns it. This can be used to convert little-endian 32 bit numbers to big-endian 32 bit numbers or vice versa.
---@param x number number
---@return y number bitwise swapped number
function bit.bswap(x) end
---Returns the bitwise xor of all of its arguments. Note that more than two arguments are allowed.
---@param x1 number number
---@param ... number number(s)
---@return y number bitwise xor of the provided arguments
...
---@param x number number
---@param n number number of bits
---@return y number bitwise logical left-shifted number
...
---@param x number number
---@param n number number of bits
---@return y number bitwise left-rotated number
...
---@param x number number
---@param n number number of bits
---@return y number bitwise right-rotated number
...
---@return s string hexadecimal string
