...
---@param buffers table table with keys specifying which buffers to clear and values set to clear values. Available keys are: <ul> render.BUFFER_COLOR_BIT render.BUFFER_DEPTH_BIT render.BUFFER_STENCIL_BIT </ul>
...
---@param state constant state to disable <ul> render.STATE_DEPTH_TEST render.STATE_STENCIL_TEST render.STATE_BLEND render.STATE_ALPHA_TEST ( not available on iOS and Android) render.STATE_CULL_FACE render.STATE_POLYGON_OFFSET_FILL </ul>
...
---@param state constant state to enable <ul> render.STATE_DEPTH_TEST render.STATE_STENCIL_TEST render.STATE_BLEND render.STATE_ALPHA_TEST ( not available on iOS and Android) render.STATE_CULL_FACE render.STATE_POLYGON_OFFSET_FILL </ul>
...
---@param buffer_type constant buffer type from which to enable the texture <ul> render.BUFFER_COLOR_BIT render.BUFFER_DEPTH_BIT render.BUFFER_STENCIL_BIT </ul>
...
---@param buffer_type constant which type of buffer to retrieve the height from <ul> render.BUFFER_COLOR_BIT render.BUFFER_DEPTH_BIT render.BUFFER_STENCIL_BIT </ul>
...
---@param buffer_type constant which type of buffer to retrieve the width from <ul> render.BUFFER_COLOR_BIT render.BUFFER_DEPTH_BIT render.BUFFER_STENCIL_BIT </ul>
...
---@param face_type constant face type <ul> render.FACE_FRONT render.FACE_BACK render.FACE_FRONT_AND_BACK </ul>
...
---render.STENCIL_OP_REPLACE (sets the stencil buffer value to ref, as specified by <a href="/ref/render#render.set_stencil_func">render.set_stencil_func</a>)
